  ...
  return (
    ...
    <Navbar/>
      <section class="flex items-center bg-stone-100 lg:h-screen font-poppins dark:bg-gray-800 ">
            ...
            <p class="text-sm dark:text-gray-400">Lorem ipsum dor amet ispicusus isopiros amet ispis lorem </p>
            </div>
            ...
            <form action="" class="p-6 bg-gray-50 dark:bg-gray-900 shadow-lg">
            <div class="mb-6 ">
            <label for="firstname" class="block mb-2 font-bold text-gray-700 uppercase dark:text-gray-400">
            Email</label>
            <input type="text" placeholder="abc@gmail.com" required="" class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border border-gray-200 rounded dark:placeholder-gray-500 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 "/>
            </div>
            <div class="mb-6 ">
            <label for="firstname" class="block mb-2 font-bold text-gray-700 uppercase dark:text-gray-400">
            Subject</label>
            <input type="text" placeholder="I'm asking information for..." required="" class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border border-gray-200 rounded dark:text-gray-400 dark:placeholder-gray-500 dark:border-gray-800 dark:bg-gray-800"/>
            </div>
            <div class="mb-6 ">
            <label for="firstname" class="block mb-2 font-bold text-gray-700 uppercase dark:text-gray-400">
            Message</label>
            <textarea type="message" placeholder="Describe your problem" required="" class="block w-full px-4 leading-tight text-gray-700 bg-gray-100 border border-gray-200 rounded dark:placeholder-gray-500 py-7 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 "></textarea>
            </div>
